...
// NewConnectionCallback is used to notify the game module about new player connections.
type NewConnectionCallback func(playerId string)

// Hub handles communication with player devices.
type Hub struct {
...
func (h *Hub) RegisterNewConnectionCallback(cb NewConnectionCallback) {
	h.newConnectionCallback = cb
}

func (h *Hub) HandleNewConnection(playerChannel PlayerChannel) {
...
func (h *Hub) SendTo(playerId string, message interface{}) error {
